...
export default function ColdWarTopic({ html }) {
  return (
    <>
      <Head>
        <title>The Cold War - AQA GCSE History Revision</title>
...
export async function getStaticProps() {
  try {
    const filePath = path.join(process.cwd(), 'public', 'topics', 'cold-war.html');
    ...
    console.error('Error reading cold-war.html:', error);
    return {
      props: {
