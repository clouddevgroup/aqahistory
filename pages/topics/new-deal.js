...
export default function NewDealTopic({ html }) {
  return (
    <>
      <Head>
        <title>The New Deal - AQA GCSE History Revision</title>
...
export async function getStaticProps() {
  try {
    const filePath = path.join(process.cwd(), 'public', 'topics', 'new-deal.html');
    ...
    console.error('Error reading new-deal.html:', error);
    return {
      props: {
