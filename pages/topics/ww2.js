...
export default function WW2Topic({ html }) {
  return (
    <>
      <Head>
        <title>World War II - AQA GCSE History Revision</title>
...
export async function getStaticProps() {
  try {
    const filePath = path.join(process.cwd(), 'public', 'topics', 'ww2.html');
    ...
    console.error('Error reading ww2.html:', error);
    return {
      props: {
