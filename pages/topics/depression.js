...
export default function DepressionTopic({ html }) {
  return (
    <>
      <Head>
        <title>The Great Depression - AQA GCSE History Revision</title>
...
export async function getStaticProps() {
  try {
    const filePath = path.join(process.cwd(), 'public', 'topics', 'depression.html');
    ...
    console.error('Error reading depression.html:', error);
    return {
      props: {
