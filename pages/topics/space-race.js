...
export default function SpaceRaceTopic({ html }) {
  return (
    <>
      <Head>
        <title>The Space Race - AQA GCSE History Revision</title>
...
export async function getStaticProps() {
  try {
    const filePath = path.join(process.cwd(), 'public', 'topics', 'space-race.html');
    ...
    console.error('Error reading space-race.html:', error);
    return {
      props: {
